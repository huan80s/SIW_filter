...
const int N_circle = 1;	//12
const int N_end = 2;		//2
const int N_middle = 3;		//8
const int N_post1 = 0;		//2
const int N_post2 = 0;		//1
...
void scan_coef_Matrix_end2(complex** Coef, int num_total, int ** Coef_location, int sizeM, int sizeN, int offset)
{
	...
	//******************************************************************************************
	int num_total_1 = Nx_2 + Nx_3 + Num1 * 2 + Num2 * 2 + Num3 * 2 + Num4 * 2 + Num5 * 2 + Num6 * 2 + Num7 * 2 + Num8 * 2 + Num9;
	for (i = (num_total_1 - Nx_2 - Nx_3 - Num1); i<(num_total_1 - Nx_2 - Nx_3 - Num1 + Node_1 + 2); i++)// circle num17(1) Nx_2:  74 node!  part1 !
	{
		switch (i - num_total_1 + Nx_2 + Nx_3 + Num1)
		{
		case 0:
		...
		case (Node_1 + 1) ://2 lei xia 1j
			...
			break;
		default:
			if ((i - num_total_1 + Nx_2 + Nx_3 + Num1) < (N_d0 - 3))// 4dx!
			{
				inner_5node(j, j - offset, 4, -Num5 - Num4 - Num3 - Num2, Nx_2 + Nx_3, Coef, Coef_location);
			}
			else if (((i - num_total_1 + Nx_2 + Nx_3 + Num1) > (N_d0 - 3)) && ((i - num_total_1 + Nx_2 + Nx_3 + Num1) < Node11))// 2dx!
			{
				inner_5node(j, j - offset, 2, -(Num3 + Num2 + N_d0 - 2), Num1 - N_d0 + 2, Coef, Coef_location);
			}
			else if (((i - num_total_1 + Nx_2 + Nx_3 + Num1) >= Node11) && ((i - num_total_1 + Nx_2 + Nx_3 + Num1) <= Node12))// 2 lei right 2j !
			{
				kind2_node(j, j - offset, -((i - num_total_1 + Nx_2 + Nx_3 + Num1) + Num2 - (i - num_total_1 + Nx_2 + Nx_3 + Num1 - Node11) * 2),
	...
	for (i = (num_total_1 - Nx_2 - Nx_3 - Num1 + Node_1 + 2); i<(num_total_1 - Nx_2 - Nx_3); i++)// circle num17(1) Nx_2:  74 node!  part2 !
	{
		switch (i - num_total_1 + Nx_2 + Nx_3 + Num1)
		{
		case (Num1 - 1) :
		...
		case (Node_11 + 1) ://2 lei xia 1j
			...
			break;
		default:
			if ((i - num_total_1 + Nx_2 + Nx_3 + Num1) < (Node_1 + N_a - 4))// 4dx!
			{
				inner_5node(j, j - offset, 4, -(Num5 - Node_5 + Num4 + Num3 + Num2 + Node_1), Nx_2 + Nx_3, Coef, Coef_location);
			}
			else if (((i - num_total_1 + Nx_2 + Nx_3 + Num1) > (Node_1 + N_a - 4)) && ((i - num_total_1 + Nx_2 + Nx_3 + Num1) < Node13))// 2dx!
			{
				inner_5node(j, j - offset, 2, -(Num3 / 2 + Num2 + Node_1 + N_a - 3), Num1 - Node_11 + Nx_3 - 1, Coef, Coef_location);
			}
			else if (((i - num_total_1 + Nx_2 + Nx_3 + Num1) >= Node13) && ((i - num_total_1 + Nx_2 + Nx_3 + Num1) <= Node14))// 2 lei left 2j !
			{
				kind2_node(j, j - offset, -((i - num_total_1 + Nx_2 + Nx_3 + Num1) + Num2 / 2 - (i - num_total_1 + Nx_2 + Nx_3 + Num1 - Node13) * 2),
					-1, 0, 1, Num1 - Node_11 + Nx_3 - 1, Nx_2 + Nx_3, B2, B3, B1_2, B3, B4, B5, Coef, Coef_location);
			}
			else if (((i - num_total_1 + Nx_2 + Nx_3 + Num1) >= Node14) && ((i - num_total_1 + Nx_2 + Nx_3 + Num1) <= Node_11))// 2dx
			{
...
void scan_coef_Matrix_middle_wrapper(int &j, complex** Coef, int** Coef_location, int num_total, int num, int offset){
	...
	for (i = (Nx_2 + Nx_3 + Num1 + Num2 + Num3 + Num4 + Num5); i<(Nx_2 + Nx_3 + Num1 + Num2 + Num3 + Num4 + Num5 + Num6); i++)// num 6 :  16 node!
	{
		...
		{
		case 0:// 1 lei 2j shang
			kind1_node(j, j - offset, -(Num5 - N_d0 - 2) - 2, -(Num5 - N_d0 - 2) - 1, -(Num5 - N_d0 - 2), 0, 1, Num6 + 4 - 2, Num6 + 4 - 1, Num6 + 4,
				A2_2, A1_2, A3_2, A5_2, A4_2, A2_2, A1_2, A3_2, Coef, Coef_location);
			break;
		case Node61:// inner 3 node
			inner_3node(j, j - offset, -(Num5 - N_d0 - 2), -1, 0, 1, 1, k*k*dx*dx - 4, Coef, Coef_location);
			break;
		case (Node61 + 1) :// inner 3 node
			inner_3node(j, j - offset, -(Num5 - N_d0 - 2 - 2), 0, 1, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case (Num6 / 2 - 1) :// 1 lei 2j xia
			kind1_node(j, j - offset, -(Num5 - N_d0 - 2 - 2), -(Num5 - N_d0 - 2 - 2) + 1, -(Num5 - N_d0 - 2 - 2) + 2, -1, 0,
			Num6 + 4 - 2, Num6 + 4 - 2 + 1, Num6 + 4 - 2 + 2,
			A3_2, A1_2, A2_2, A4_2, A5_2, A3_2, A1_2, A2_2, Coef, Coef_location);
			break;
		case (Num6 / 2) :// 1 lei 2j shang
			kind1_node(j, j - offset, -(Num5 - Node_55 + 4 + Num6 - 1) - 2 - 2, -(Num5 - Node_55 + 4 + Num6 - 1) - 2 - 1, -(Num5 - Node_55 + 4 + Num6 - 1) - 2, 0, 1,
			Num7 - 4 + 2 - 2, Num7 - 4 + 2 - 1, Num7 - 4 + 2, A2_2, A1_2, A3_2, A5_2, A4_2, A2_2, A1_2, A3_2, Coef, Coef_location);
			break;
		case Node62:// inner 3 node
			inner_3node(j, j - offset, -(Num5 - Node_55 + 4 + Num6 - 1) - 2, -1, 0, 1, 1, k*k*dx*dx - 4, Coef, Coef_location);
			break;
		case (Node62 + 1) :// inner 3 node
			inner_3node(j, j - offset, -(Num5 - Node_55 + 4 + Num6 - 1), 0, 1, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case (Num6 - 1) :// 1 lei 2j xia
			kind1_node(j, j - offset, -(Num5 - Node_55 + 4 + Num6 - 1), -(Num5 - Node_55 + 4 + Num6 - 1) + 1, -(Num5 - Node_55 + 4 + Num6 - 1) + 2, -1, 0,
		...
		default:
			...
			{
				inner_5node(j, j - offset, 1, -(Num5 - N_d0 - 2), Num6 + 4, Coef, Coef_location);
			}
			else if (((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5) > (Node61 + 1)) && ((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5) < (Num6 / 2 - 1)))// 2dx
			{
				inner_5node(j, j - offset, 1, -(Num5 - N_d0 - 2 - 2), Num6 + 4 - 2, Coef, Coef_location);
			}
			else if (((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5) > (Num6 / 2)) && ((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5) < Node62))// 2dx
			{
				inner_5node(j, j - offset, 1, -(Num5 - Node_55 + 4 + Num6 - 1) - 2, Num7 - 4 + 2, Coef, Coef_location);
			}
			else// 1dx 4_node
			{
				inner_5node(j, j - offset, 1, -(Num5 - Node_55 + 4 + Num6 - 1), Num7 - 4, Coef, Coef_location);
			}
			break;
		}
		j = j + 1;
	...
	for (i = (Nx_2 + Nx_3 + Num1 + Num2 + Num3 + Num4 + Num5 + Num6); i<(Nx_2 + Nx_3 + Num1 + Num2 + Num3 + Num4 + Num5 + Num6 + Num7 / 2); i++)// num 7 :  28 node! part1
	{
		...
		{
		case 0:// 1 lei 1j shang
			kind1_node(j, j - offset, -(Num5 - N_d0 + 2 + Num6) - 2, -(Num5 - N_d0 + 2 + Num6) - 1, -(Num5 - N_d0 + 2 + Num6), 0, 1,
				Num7 + Num8 + N_d0 - 2 - 2, Num7 + Num8 + N_d0 - 2 - 1, Num7 + Num8 + N_d0 - 2,
				A2_1, A1_1, A3_1, A5_1, A4_1, A2_1, A1_1, A3_1, Coef, Coef_location);
			break;
		case 3:// 2 lei 2j shang
			kind2_node(j, j - offset, -(Num5 - N_d0 + 2 + Num6), -2, -1, 0, 1, Num7 + Num8 + N_d0 - 2,
				B3, B5, B4, B1_2, B2, B3, Coef, Coef_location);
			break;
		case Node71://inner 4 node
			inner_4node(j, j - offset, -(Num6 + 4), -1, 0, Num7 - 4, 1, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case (Node71 + 1) ://inner 4 node
			inner_4node(j, j - offset, -(Num6 + 4) + 2, 0, 1, Num7 - 4, 1, k*k*dx*dx - 4, 1, 1, Coef, Coef_location);
			break;
		case (Num7 / 2 - 4) :// 2 lei 2j xia
			kind2_node(j, j - offset, -(Num5 - Node_5 + Num6 + Num7 / 2 - 1), -1, 0, 1, 2, Num7 / 2 + 1 + Num8 + Node_9,
			B3, B2, B1_2, B4, B5, B3, Coef, Coef_location);
			break;
		case (Num7 / 2 - 1) :// 1 lei 1j xia
			kind1_node(j, j - offset, -(Num5 - Node_5 + Num6 + Num7 / 2 - 1), -(Num5 - Node_5 + Num6 + Num7 / 2 - 1) + 1, -(Num5 - Node_5 + Num6 + Num7 / 2 - 1) + 2, -1, 0,
		...
		default:
			...
			{
				inner_5node(j, j - offset, 2, -(Num5 - N_d0 + 2 + Num6), Num7 + Num8 + N_d0 - 2, Coef, Coef_location);
			}
			else if (((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5 - Num6) > 3) && ((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5 - Num6) < (Node71)))// 1dx
			{
				inner_5node(j, j - offset, 1, -(Num6 + 4), Num7 - 4, Coef, Coef_location);
			}
			else if (((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5 - Num6) > (Node71 + 1)) && ((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5 - Num6) < (Num7 / 2 - 4)))// 1dx
			{
				inner_5node(j, j - offset, 1, -(Num6 + 4) + 2, Num7 - 4, Coef, Coef_location);
			}
			else// 2dx
			{
				inner_5node(j, j - offset, 2, -(Num5 - Node_5 + Num6 + Num7 / 2 - 1), Num7 / 2 + 1 + Num8 + Node_9, Coef, Coef_location);
			}
			break;
		}
		j = j + 1;
		...
		i<(Nx_2 + Nx_3 + Num1 + Num2 + Num3 + Num4 + Num5 + Num6 + Num7); i++)// num 7 :  28 node! part2
	{
		...
		case (Num7 / 2) :// 1 lei 1j shang
			kind1_node(j, j - offset, -(Num5 - Node_5 - N_a + 3 + Num6 + Num7 / 2) - 2, -(Num5 - Node_5 - N_a + 3 + Num6 + Num7 / 2) - 1, -(Num5 - Node_5 - N_a + 3 + Num6 + Num7 / 2), 0, 1,
			Num7 / 2 + Num8 + Node_9 + N_a - 3 - 2, Num7 / 2 + Num8 + Node_9 + N_a - 3 - 1, Num7 / 2 + Num8 + Node_9 + N_a - 3,
			A2_1, A1_1, A3_1, A5_1, A4_1, A2_1, A1_1, A3_1, Coef, Coef_location);
			break;
		case (Num7 / 2 + 3) :// 2 lei 2j shang
			kind2_node(j, j - offset, -(Num5 - Node_5 - N_a + 3 + Num6 + Num7 / 2), -2, -1, 0, 1, Num7 / 2 + Num8 + Node_9 + N_a - 3,
			B3, B5, B4, B1_2, B2, B3, Coef, Coef_location);
			break;
		case Node72://inner 4 node
			inner_4node(j, j - offset, -(Num7 - 5 + 1) - 2, -1, 0, 5 + Num8 - 1, 1, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case (Node72 + 1) ://inner 4 node
			inner_4node(j, j - offset, -(Num7 - 5 + 1), 0, 1, 5 + Num8 - 1, 1, k*k*dx*dx - 4, 1, 1, Coef, Coef_location);
			break;
		case (Num7 - 4) :// 2 lei 2j xia
			kind2_node(j, j - offset, -(Num5 - Node_55 + Num6 + Num7 - 1), -1, 0, 1, 2, 1 + Num8 + Node_99,
			B3, B2, B1_2, B4, B5, B3, Coef, Coef_location);
			break;
		case (Num7 - 1) :// 1 lei 1j xia
			kind1_node(j, j - offset, -(Num5 - Node_55 + Num6 + Num7 - 1), -(Num5 - Node_55 + Num6 + Num7 - 1) + 1, -(Num5 - Node_55 + Num6 + Num7 - 1) + 2, -1, 0,
		...
		default:
			...
			{
				inner_5node(j, j - offset, 2, -(Num5 - Node_5 - N_a + 3 + Num6 + Num7 / 2), Num7 / 2 + Num8 + Node_9 + N_a - 3, Coef, Coef_location);
			}
			else if (((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5 - Num6) > (Num7 / 2 + 3)) && ((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5 - Num6) < (Node72)))// 1dx
			{
				inner_5node(j, j - offset, 1, -(Num7 - 5 + 1) - 2, 5 + Num8 - 1, Coef, Coef_location);
			}
			else if (((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5 - Num6) > (Node72 + 1)) && ((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5 - Num6) < (Num7 - 4)))// 1dx
			{
				inner_5node(j, j - offset, 1, -(Num7 - 5 + 1), 5 + Num8 - 1, Coef, Coef_location);
			}
			else// 2dx
			{
				inner_5node(j, j - offset, 2, -(Num5 - Node_55 + Num6 + Num7 - 1), 1 + Num8 + Node_99, Coef, Coef_location);
			}
			break;
		}
		j = j + 1;
		...
		i<(Nx_2 + Nx_3 + Num1 + Num2 + Num3 + Num4 + Num5 + Num6 + Num7 + Num8); i++)// num 8 :  12 node! 
	{
		...
		case 0:// 1 lei shang 2j
			kind1_node(j, j - offset, -(Num7 - 4) - 2, -(Num7 - 4) - 1, -(Num7 - 4), 0, 1, Num8 + N_d0 + 2 - 2, Num8 + N_d0 + 2 - 1, Num8 + N_d0 + 2,
				A2_2, A1_2, A3_2, A5_2, A4_2, A2_2, A1_2, A3_2, Coef, Coef_location);
			break;
		case 1:
			inner_5node(j, j - offset, 1, -(Num7 - 4), Num8 + N_d0 + 2, Coef, Coef_location);
			break;
		case 2://inner 4 node
			inner_4node(j, j - offset, -(Num7 - 4), -1, 0, Num8 + N_d0 + 2, 1, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case 3://inner 4 node
			inner_4node(j, j - offset, -(Num7 - 4), 0, 1, Num8 + N_d0 + 2, 1, k*k*dx*dx - 4, 1, 1, Coef, Coef_location);
			break;
		case 4:
			inner_5node(j, j - offset, 1, -(Num7 - 4), Num8 + N_d0 + 2, Coef, Coef_location);
			break;
		case (Num8 / 2 - 1) :// 1 lei xia 2j
			kind1_node(j, j - offset, -(Num7 - 4), -(Num7 - 4) + 1, -(Num7 - 4) + 2, -1, 0, Num8 + N_d0 + 2, Num8 + N_d0 + 2 + 1, Num8 + N_d0 + 2 + 2,
			A3_2, A1_2, A2_2, A4_2, A5_2, A3_2, A1_2, A2_2, Coef, Coef_location);
			break;
		case (Num8 / 2) :// 1 lei shang 2j
			kind1_node(j, j - offset, -(5 + Num8 - 1) - 2, -(5 + Num8 - 1) - 1, -(5 + Num8 - 1), 0, 1,
			Node_99 - 4 + 1 - 2, Node_99 - 4 + 1 - 1, Node_99 - 4 + 1,
			A2_2, A1_2, A3_2, A5_2, A4_2, A2_2, A1_2, A3_2, Coef, Coef_location);
			break;
		case 7:
			inner_5node(j, j - offset, 1, -(5 + Num8 - 1), Node_99 - 4 + 1, Coef, Coef_location);
			break;
		case 8://inner 4 node
			inner_4node(j, j - offset, -(5 + Num8 - 1), -1, 0, Node_99 - 4 + 1, 1, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case 9://inner 4 node
			inner_4node(j, j - offset, -(5 + Num8 - 1), 0, 1, Node_99 - 4 + 1, 1, k*k*dx*dx - 4, 1, 1, Coef, Coef_location);
			break;
		case 10:
			inner_5node(j, j - offset, 1, -(5 + Num8 - 1), Node_99 - 4 + 1, Coef, Coef_location);
			break;
		case (Num8 - 1) :// 1 lei xia 2j
			kind1_node(j, j - offset, -(5 + Num8 - 1), -(5 + Num8 - 1) + 1, -(5 + Num8 - 1) + 2, -1, 0,
		...
		i<(Nx_2 + Nx_3 + Num1 + Num2 + Num3 + Num4 + Num5 + Num6 + Num7 + Num8 + Node_9 + 2); i++)// circle num9 :  72 node!  part1 !
	{
		...
		{
		case 0:
			boundary_node(j, j - offset, 1, -Num5 - Num6 - Num7 - Num8, Num9 + Num8 + Num7 + Num6, Coef, Coef_location);
			break;
		case (N_d0 - 3) ://2 lei shang 1j
			kind2_node(j, j - offset, -Num5 - Num6 - Num7 - Num8, -2, -1, 0, 1, Num9 + Num8 + Num7 + Num6,
			B3, B5, B4, B1_1, B2, B3, Coef, Coef_location);
			break;
		case (N_d0 + 1) :// 2 lei 2j shang
			kind2_node(j, j - offset, -(Num7 + Num8 + N_d0 - 2), -2, -1, 0, 1, Num9 - N_d0 + 2 + Num8,
			B3, B5, B4, B1_2, B2, B3, Coef, Coef_location);
			break;
		case Node91:// inner 4 node
			inner_4node(j, j - offset, -(Num8 + N_d0 + 2), -1, 0, Num9 - N_d0 - 2, 1, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case (Node91 + 1) :// inner 4 node
			inner_4node(j, j - offset, -(Num8 + N_d0 + 2), 0, 1, Num9 - N_d0 - 2, 1, k*k*dx*dx - 4, 1, 1, Coef, Coef_location);
			break;
		case (Node_9 - 3) ://2 lei xia 2j
			kind2_node(j, j - offset, -(Num7 / 2 + 1 + Num8 + Node_9), -1, 0, 1, 2, Num9 - Node_9 + Num8 + Num7 / 2 - 1,
			B3, B2, B1_2, B4, B5, B3, Coef, Coef_location);
			break;
		case (Node_9 + 1) ://2 lei xia 1j
			kind2_node(j, j - offset, -(Num5 - Node_5 + Num6 + Num7 + Num8 + Node_9), -1, 0, 1, 2, Num9 - Node_9 + Num8 + Num7 + Num6 + Node_5,
			B3, B2, B1_1, B4, B5, B3, Coef, Coef_location);
			break;
		default:
			if ((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5 - Num6 - Num7 - Num8) < (N_d0 - 3))// 4dx!
			{
				inner_5node(j, j - offset, 4, -Num5 - Num6 - Num7 - Num8, Num9 + Num8 + Num7 + Num6, Coef, Coef_location);
			}
			...
			{
				inner_5node(j, j - offset, 2, -(Num7 + Num8 + N_d0 - 2), Num9 - N_d0 + 2 + Num8, Coef, Coef_location);
			}
			...
			{
				inner_5node(j, j - offset, 1, -(Num8 + N_d0 + 2), Num9 - N_d0 - 2, Coef, Coef_location);
			}
			...
			{
				inner_5node(j, j - offset, 2, -(Num7 / 2 + 1 + Num8 + Node_9), Num9 - Node_9 + Num8 + Num7 / 2 - 1, Coef, Coef_location);
			}
			break;
		}
		j = j + 1;
		...
		i<(Nx_2 + Nx_3 + Num1 + Num2 + Num3 + Num4 + Num5 + Num6 + Num7 + Num8 + Num9); i++)// circle num9 :  72 node!  part2 !
	{
		...
		{
		case (Num9 - 1) :
			boundary_node(j, j - offset, 2, -Num6 - Num7 - Num8 - Num9, Num8 + Num7 + Num6 + Num5, Coef, Coef_location);
			break;
		case (Node_9 + N_a - 4) ://2 lei shang 1j
			kind2_node(j, j - offset, -(Num5 - Node_5 + Num6 + Num7 + Num8 + Node_9), -2, -1, 0, 1, Num9 - Node_9 + Num8 + Num7 + Num6 + Node_5,
			B3, B5, B4, B1_1, B2, B3, Coef, Coef_location);
			break;
		case (Node_9 + N_a) :// 2 lei 2j shang
			kind2_node(j, j - offset, -(Num7 / 2 + Num8 + Node_9 + N_a - 3), -2, -1, 0, 1, Num9 - Node_9 - N_a + 3 + Num8 + Num7 / 2,
			B3, B5, B4, B1_2, B2, B3, Coef, Coef_location);
			break;
		case Node92:// inner 4 node
			inner_4node(j, j - offset, -(Node_99 - 4 + 1), -1, 0, Num9 - Node_99 + 4 + Num8 - 1, 1, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case (Node92 + 1) :// inner 4 node
			inner_4node(j, j - offset, -(Node_99 - 4 + 1), 0, 1, Num9 - Node_99 + 4 + Num8 - 1, 1, k*k*dx*dx - 4, 1, 1, Coef, Coef_location);
			break;
		case (Node_99 - 3) ://2 lei xia 2j
			kind2_node(j, j - offset, -(Num8 + Node_99 + 1), -1, 0, 1, 2, Num9 - Node_99 + Num8 + Num7 - 1,
			B3, B2, B1_2, B4, B5, B3, Coef, Coef_location);
			break;
		case (Node_99 + 1) ://2 lei xia 1j
			kind2_node(j, j - offset, -Num6 - Num7 - Num8 - Num9, -1, 0, 1, 2, Num8 + Num7 + Num6 + Num5,
			B3, B2, B1_1, B4, B5, B3, Coef, Coef_location);
			break;
		default:
			if ((i - Nx_2 - Nx_3 - Num1 - Num2 - Num3 - Num4 - Num5 - Num6 - Num7 - Num8) < (Node_9 + N_a - 4))// 4dx!
			{
				inner_5node(j, j - offset, 4, -(Num5 - Node_5 + Num6 + Num7 + Num8 + Node_9), Num9 - Node_9 + Num8 + Num7 + Num6 + Node_5, Coef, Coef_location);
			}
			...
			{
				inner_5node(j, j - offset, 2, -(Num7 / 2 + Num8 + Node_9 + N_a - 3), Num9 - Node_9 - N_a + 3 + Num8 + Num7 / 2, Coef, Coef_location);
			}
			...
			{
				inner_5node(j, j - offset, 1, -(Node_99 - 4 + 1), Num9 - Node_99 + 4 + Num8 - 1, Coef, Coef_location);
			}
			...
			{
				inner_5node(j, j - offset, 2, -(Num8 + Node_99 + 1), Num9 - Node_99 + Num8 + Num7 - 1, Coef, Coef_location);
			}
			else// 4dx!
			{
				inner_5node(j, j - offset, 4, -Num6 - Num7 - Num8 - Num9, Num8 + Num7 + Num6 + Num5, Coef, Coef_location);
			}
			break;
		}
		j = j + 1;
		...
		i<(Nx_2 + Nx_3 + Num1 + Num2 + Num3 + Num4 + Num5 + Num6 + Num7 + Num8 * 2 + Num9); i++)// num 10(8) :  12 node! 
	{
		...
		{
		case 0:// 1 lei shang 2j
			kind1_node(j, j - offset, -(Num9 - N_d0 - 2) - 2, -(Num9 - N_d0 - 2) - 1, -(Num9 - N_d0 - 2), 0, 1, Num8 + 4 - 2, Num8 + 4 - 1, Num8 + 4,
				A2_2, A1_2, A3_2, A5_2, A4_2, A2_2, A1_2, A3_2, Coef, Coef_location);
			break;
		case 1:
			inner_5node(j, j - offset, 1, -(Num9 - N_d0 - 2), Num8 + 4, Coef, Coef_location);
			break;
		case 2://inner 4 node
			inner_4node(j, j - offset, -(Num9 - N_d0 - 2), -1, 0, Num8 + 4, 1, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case 3://inner 4 node
			inner_4node(j, j - offset, -(Num9 - N_d0 - 2), 0, 1, Num8 + 4, 1, k*k*dx*dx - 4, 1, 1, Coef, Coef_location);
			break;
		case 4:
			inner_5node(j, j - offset, 1, -(Num9 - N_d0 - 2), Num8 + 4, Coef, Coef_location);
			break;
		case (Num8 / 2 - 1) :// 1 lei xia 2j
			kind1_node(j, j - offset, -(Num9 - N_d0 - 2), -(Num9 - N_d0 - 2) + 1, -(Num9 - N_d0 - 2) + 2, -1, 0, Num8 + 4, Num8 + 4 + 1, Num8 + 4 + 2,
			A3_2, A1_2, A2_2, A4_2, A5_2, A3_2, A1_2, A2_2, Coef, Coef_location);
			break;
		case (Num8 / 2) :// 1 lei shang 2j
			kind1_node(j, j - offset, -(Num9 - Node_99 + 4 + Num8 - 1) - 2, -(Num9 - Node_99 + 4 + Num8 - 1) - 1, -(Num9 - Node_99 + 4 + Num8 - 1), 0, 1,
			Num7 - 4 - 2, Num7 - 4 - 1, Num7 - 4, A2_2, A1_2, A3_2, A5_2, A4_2, A2_2, A1_2, A3_2, Coef, Coef_location);
			break;
		case 7:
			inner_5node(j, j - offset, 1, -(Num9 - Node_99 + 4 + Num8 - 1), Num7 - 4, Coef, Coef_location);
			break;
		case 8://inner 4 node
			inner_4node(j, j - offset, -(Num9 - Node_99 + 4 + Num8 - 1), -1, 0, Num7 - 4, 1, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case 9://inner 4 node
			inner_4node(j, j - offset, -(Num9 - Node_99 + 4 + Num8 - 1), 0, 1, Num7 - 4, 1, k*k*dx*dx - 4, 1, 1, Coef, Coef_location);
			break;
		case 10:
			inner_5node(j, j - offset, 1, -(Num9 - Node_99 + 4 + Num8 - 1), Num7 - 4, Coef, Coef_location);
			break;
		case (Num8 - 1) :// 1 lei xia 2j
			kind1_node(j, j - offset, -(Num9 - Node_99 + 4 + Num8 - 1), -(Num9 - Node_99 + 4 + Num8 - 1) + 1, -(Num9 - Node_99 + 4 + Num8 - 1) + 2, -1, 0,
			Num7 - 4, Num7 - 4 + 1, Num7 - 4 + 2,
			A3_2, A1_2, A2_2, A4_2, A5_2, A3_2, A1_2, A2_2, Coef, Coef_location);
			break;
		}
		...
		i<(Nx_2 + Nx_3 + Num1 + Num2 + Num3 + Num4 + Num5 + Num6 + Num7 + Num8 * 2 + Num9 + Num7 / 2); i++)// num 11(7) :  28 node! part1
	{
		...
		{
		case 0:// 1 lei 1j shang
			kind1_node(j, j - offset, -(Num9 - N_d0 + 2 + Num8) - 2, -(Num9 - N_d0 + 2 + Num8) - 1, -(Num9 - N_d0 + 2 + Num8), 0, 1,
				Num7 + Num6 + N_d0 - 2 - 2, Num7 + Num6 + N_d0 - 2 - 1, Num7 + Num6 + N_d0 - 2,
				A2_1, A1_1, A3_1, A5_1, A4_1, A2_1, A1_1, A3_1, Coef, Coef_location);
			break;
		case 3:// 2 lei 2j shang
			kind2_node(j, j - offset, -(Num9 - N_d0 + 2 + Num8), -2, -1, 0, 1, Num7 + Num6 + N_d0 - 2,
				B3, B5, B4, B1_2, B2, B3, Coef, Coef_location);
			break;
		case Node71://inner 4 node
			inner_4node(j, j - offset, -(Num8 + 4), -1, 0, Num7 - 4, 1, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case (Node71 + 1) ://inner 4 node
			inner_4node(j, j - offset, -(Num8 + 4), 0, 1, Num7 - 4 + 2, 1, k*k*dx*dx - 4, 1, 1, Coef, Coef_location);
			break;
		case (Num7 / 2 - 4) :// 2 lei 2j xia
			kind2_node(j, j - offset, -(Num9 - Node_9 + Num8 + Num7 / 2 - 1), -1, 0, 1, 2, Num7 / 2 + 1 + Num6 + Node_5,
			B3, B2, B1_2, B4, B5, B3, Coef, Coef_location);
			break;
		case (Num7 / 2 - 1) :// 1 lei 1j xia
			kind1_node(j, j - offset, -(Num9 - Node_9 + Num8 + Num7 / 2 - 1), -(Num9 - Node_9 + Num8 + Num7 / 2 - 1) + 1, -(Num9 - Node_9 + Num8 + Num7 / 2 - 1) + 2, -1, 0,
		...
		default:
			...
			{
				inner_5node(j, j - offset, 2, -(Num9 - N_d0 + 2 + Num8), Num7 + Num6 + N_d0 - 2, Coef, Coef_location);
			}
			...
			{
				inner_5node(j, j - offset, 1, -(Num8 + 4), Num7 - 4, Coef, Coef_location);
			}
			...
			{
				inner_5node(j, j - offset, 1, -(Num8 + 4), Num7 - 4 + 2, Coef, Coef_location);
			}
			else// 2dx
			{
				inner_5node(j, j - offset, 2, -(Num9 - Node_9 + Num8 + Num7 / 2 - 1), Num7 / 2 + 1 + Num6 + Node_5, Coef, Coef_location);
			}
			break;
		}
		j = j + 1;
		...
		i<(Nx_2 + Nx_3 + Num1 + Num2 + Num3 + Num4 + Num5 + Num6 + Num7 * 2 + Num8 * 2 + Num9); i++)// num 11(7) :  28 node! part2
	{
		...
		{
		case (Num7 / 2) :// 1 lei 1j shang
			kind1_node(j, j - offset, -(Num9 - Node_9 - N_a + 3 + Num8 + Num7 / 2) - 2, -(Num9 - Node_9 - N_a + 3 + Num8 + Num7 / 2) - 1, -(Num9 - Node_9 - N_a + 3 + Num8 + Num7 / 2), 0, 1,
			Num7 / 2 + Num6 + Node_5 + N_a - 3 - 2, Num7 / 2 + Num6 + Node_5 + N_a - 3 - 1, Num7 / 2 + Num6 + Node_5 + N_a - 3,
			A2_1, A1_1, A3_1, A5_1, A4_1, A2_1, A1_1, A3_1, Coef, Coef_location);
			break;
		case (Num7 / 2 + 3) :// 2 lei 2j shang
			kind2_node(j, j - offset, -(Num9 - Node_9 - N_a + 3 + Num8 + Num7 / 2), -2, -1, 0, 1, Num7 / 2 + Num6 + Node_5 + N_a - 3,
			B3, B5, B4, B1_2, B2, B3, Coef, Coef_location);
			break;
		case Node72://inner 4 node
			inner_4node(j, j - offset, -(Num7 - 5 + 1), -1, 0, 5 + Num6 - 1 - 2, 1, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case (Node72 + 1) ://inner 4 node
			inner_4node(j, j - offset, -(Num7 - 5 + 1), 0, 1, 5 + Num6 - 1, 1, k*k*dx*dx - 4, 1, 1, Coef, Coef_location);
			break;
		case (Num7 - 4) :// 2 lei 2j xia
			kind2_node(j, j - offset, -(Num9 - Node_99 + Num8 + Num7 - 1), -1, 0, 1, 2, 1 + Num6 + Node_55,
			B3, B2, B1_2, B4, B5, B3, Coef, Coef_location);
			break;
		case (Num7 - 1) :// 1 lei 1j xia
			kind1_node(j, j - offset, -(Num9 - Node_99 + Num8 + Num7 - 1), -(Num9 - Node_99 + Num8 + Num7 - 1) + 1, -(Num9 - Node_99 + Num8 + Num7 - 1) + 2, -1, 0,
		...
		default:
			...
			{
				inner_5node(j, j - offset, 2, -(Num9 - Node_9 - N_a + 3 + Num8 + Num7 / 2), Num7 / 2 + Num6 + Node_5 + N_a - 3, Coef, Coef_location);
			}
			...
			{
				inner_5node(j, j - offset, 1, -(Num7 - 5 + 1), 5 + Num6 - 1 - 2, Coef, Coef_location);
			}
			...
			{
				inner_5node(j, j - offset, 1, -(Num7 - 5 + 1), 5 + Num6 - 1, Coef, Coef_location);
			}
			else// 2dx
			{
				inner_5node(j, j - offset, 2, -(Num9 - Node_99 + Num8 + Num7 - 1), 1 + Num6 + Node_55, Coef, Coef_location);
			}
			break;
		}
		j = j + 1;
		...
		i<(Nx_2 + Nx_3 + Num1 + Num2 + Num3 + Num4 + Num5 + Num6 * 2 + Num7 * 2 + Num8 * 2 + Num9); i++)// num 12(6) :  16 node!
	{
		...
		{
		case 0:// 1 lei 2j shang
			kind1_node(j, j - offset, -(Num7 - 4) - 2, -(Num7 - 4) - 1, -(Num7 - 4), 0, 1, Num6 + N_d0 + 2 - 2, Num6 + N_d0 + 2 - 1, Num6 + N_d0 + 2,
				A2_2, A1_2, A3_2, A5_2, A4_2, A2_2, A1_2, A3_2, Coef, Coef_location);
			break;
		case Node61:// inner 3 node
			inner_3node(j, j - offset, -1, 0, (Num6 + N_d0 + 2), 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case (Node61 + 1) :// inner 3 node
			inner_3node(j, j - offset, 0, 1, (Num6 + N_d0 + 2) + 2, k*k*dx*dx - 4, 1, 1, Coef, Coef_location);
			break;
		case (Num6 / 2 - 1) :// 1 lei 2j xia
			kind1_node(j, j - offset, (-(Num7 - 4) - 2), (-(Num7 - 4) - 2) + 1, (-(Num7 - 4) - 2) + 2, -1, 0,
			(Num6 + N_d0 + 2) + 2, (Num6 + N_d0 + 2) + 2 + 1, (Num6 + N_d0 + 2) + 2 + 2,
			A3_2, A1_2, A2_2, A4_2, A5_2, A3_2, A1_2, A2_2, Coef, Coef_location);
			break;
		case (Num6 / 2) :// 1 lei 2j shang
			kind1_node(j, j - offset, -(5 + Num6 - 1) + 2 - 2, -(5 + Num6 - 1) + 2 - 1, -(5 + Num6 - 1) + 2, 0, 1,
			(Node_55 - 4 + 1) - 2 - 2, (Node_55 - 4 + 1) - 2 - 1, (Node_55 - 4 + 1) - 2,
			A2_2, A1_2, A3_2, A5_2, A4_2, A2_2, A1_2, A3_2, Coef, Coef_location);
			break;
		case Node62:// inner 3 node
			inner_3node(j, j - offset, -1, 0, (Node_55 - 4 + 1) - 2, 1, k*k*dx*dx - 4, 1, Coef, Coef_location);
			break;
		case (Node62 + 1) :// inner 3 node
			inner_3node(j, j - offset, 0, 1, (Node_55 - 4 + 1), k*k*dx*dx - 4, 1, 1, Coef, Coef_location);
			break;
		case (Num6 - 1) :// 1 lei 2j xia
			kind1_node(j, j - offset, -(5 + Num6 - 1), -(5 + Num6 - 1) + 1, -(5 + Num6 - 1) + 2, -1, 0,
			(Node_55 - 4 + 1), (Node_55 - 4 + 1) + 1, (Node_55 - 4 + 1) + 2,
			A3_2, A1_2, A2_2, A4_2, A5_2, A3_2, A1_2, A2_2, Coef, Coef_location);
			break;
		default:
			...
			{
				inner_5node(j, j - offset, 1, -(Num7 - 4), Num6 + N_d0 + 2, Coef, Coef_location);
			}
			...
			{
				inner_5node(j, j - offset, 1, -(Num7 - 4) - 2, (Num6 + N_d0 + 2) + 2, Coef, Coef_location);
			}
			...
			{
				inner_5node(j, j - offset, 1, -(5 + Num6 - 1) + 2, (Node_55 - 4 + 1) - 2, Coef, Coef_location);
			}
			else// 1dx 4_node
			{
				inner_5node(j, j - offset, 1, -(5 + Num6 - 1), (Node_55 - 4 + 1), Coef, Coef_location);
			}
			break;
		}
		j = j + 1;
...
void scan_coef_Matrix_middle(complex** Coef, int num_total, int ** Coef_location, int sizeM, int sizeN, int offset)
{
	...
	//******************************************************************************************
	int num_total_1 = Nx_2 + Nx_3 + Num1 + Num2 * 2 + Num3 * 2 + Num4 * 2 + Num5 * 2 + Num6 * 2 + Num7 * 2 + Num8 * 2 + Num9;
	for (i = (num_total_1 - Nx_2 - Nx_3 - Num1); i<(num_total_1 - Nx_2 - Nx_3 - Num1 + Node_1 + 2); i++)// circle num17(1) Nx_2:  74 node!  part1 !
	{
		switch (i - num_total_1 + Nx_2 + Nx_3 + Num1)
		{
...
void scan_binc(complex* b, int num_total)	//4dx!!!!
{
	...
	for (i = 0; i<Nx_side; i++)//left截断左边界 1阶mur吸收边界条件 均匀网格：4dx
	{
		...
		default:
			if ((i >= N_d0) && (i < (N_d0 + N_a)))// add source
			{
				b[j].real = sin(pi*(i - N_d0 + 1) * 4 * dx / a) * cos(2 * kz * 4 * dx);
	...
	for (i = (Nx_side); i<(2 * Nx_side); i++)//source node
	{
		...
		case (N_d0 - 1) :
			break;
		case N_d0:
			b[j].real = -sin(pi*(i - Nx_side - N_d0 + 1) * 4 * dx / a);
			break;
		case (N_d0 + N_a - 1) :
			b[j].real = -sin(pi*(i - Nx_side - N_d0 + 1) * 4 * dx / a);
			break;
...
void show_value(int M){
	...
	startpos[4] = startpos[3] + M_middle - overlapping_nodes;
	...
	for (int i = 0; i != M_middle; i++)
			Ey_total2_middle[2][i] = x[i + startpos[3]];
	for (int i = 0; i != M_end; i++)
		Ey_total2_end[1][i] = x[i + startpos[4]];						//end1
	...
	show_middle(2, 2, Ey_whole, Ey_total2_middle);
...
void main()// DDM-10 region
{
	...
	const int overlapping_nodes = 2 * Nx_2 + Nx_3;        //重叠区域
	...
	int M = (M_end - overlapping_nodes) + (M_middle - overlapping_nodes)* N_middle + M_end;    //节点总数
	...
	//计算的起始点
	vector<int> startpos;
	startpos.push_back(0);                                                                                //end
	startpos.push_back(startpos[0] + zone_N0 - extra_nodes0);
	startpos.push_back(startpos[1] + extra_nodes0 + overlapping_nodes + zone_N1 - extra_nodes1);
	startpos.push_back(startpos[2] + extra_nodes1 + overlapping_nodes + zone_N1 - extra_nodes1);
	startpos.push_back(startpos[3] + extra_nodes1 + overlapping_nodes + zone_N1 - extra_nodes1);
	cout << "startpos of computing:" << endl;
	for (int i = 0; i != startpos.size(); i++)
		cout << setw(2) << i << "/" << setw(3) << startpos[i] << endl;
	...
	complex* X_middle_1 = new complex[N1_1];
	complex* X_middle_11 = new complex[N1_11];
	...
	complex* B_middle_11 = new complex[M1_11];
	...
	while (bnorm > eps)
	{
		...
		projective_process(A_middle_1, b_middle_1, B_middle_1, X_middle_1, Binc, x, startpos[1], extra_nodes0, sinta, M1_1, N1_1);
		projective_process(A_middle, b_middle, B_middle, X_middle, Binc, x, startpos[2], extra_nodes1, sinta, M1, N1);
		projective_process(A_middle_11, b_middle_11, B_middle_11, X_middle_11, Binc, x, startpos[3], extra_nodes1, sinta, M1_11, N1_11);
		projective_process(A_end1, b_end1, B_end1, X_end1, Binc, x, startpos[4], extra_nodes1, sinta, M2, N2);        //end
